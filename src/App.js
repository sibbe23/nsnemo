...
// import VesseltypeEdit from './components/Settings/VesseltypeEdit';
...
//   //   const eyxcludedRoutes = ['/login', '/candidate-login'];
...
//         <Route path ='/candidate-edit/:candidateId' element={<Candidate_edit/>}/>
...
//         <Route path='/vessel-type-edit/:vesselTypeId' element={<VesseltypeEdit/>} />
...
import User_edit from './components/Dashboard/User_edit';
import VesseltypeEdit from './components/Settings/VesseltypeEdit';
import BirthdayReminder from './components/Extras/BirthdayReminder';
// import NkdAdd from './components/Candidate/NkdAdd';
// import NkdView from './components/Candidate/NkdView';
// import NkdEdit from './components/Candidate/NkdEdit';
...
function AppContent() {
  ...
  // Array of paths where the Sidebar should be displayed
  const allowedPaths = [
    '/candidate-dashboard',
    '/dashboard',
    '/candidate-add',
  ...
  return (
        <>
          ...
          <Routes>
            ...
            {/* <Route path='/nkd-add' element={<NkdAdd/>} />
            <Route path='/nkd-view' element={<NkdView/>} />
            <Route path='/nkd-edit/:nkdId' element={<NkdEdit/>} /> */}
